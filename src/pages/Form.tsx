...
if (isLoadingGeoCoding) return <p className="text-white text-center">Loading city
       info...</p>;
if (geoCodingError) return <p className="text-red-400
       text-center">{geoCodingError}</p>;
if (!lat && !lng) return <p className="text-white text-center">Click on the map
       to get started!</p>;

  return (
    <form className="bg-[#42484d] p-6 rounded-lg flex flex-col gap-4 text-white ">
